...
import { CheckCircle2, RotateCcw, Check, AlertCircle, X, Calendar } from 'lucide-react'
...
interface StoreRequestTicket {
  id: string
  items_json: Array<{ inventory_item_id?: string | null; name: string; quantity: number; requested_quantity?: number; approved_quantity?: number; category?: string; unit?: string }>
          ...
          {activeReport ? (
            ...
            <div className="flex flex-col items-center justify-center py-20 px-6 text-center space-y-3">
              ...
              <div>
                ...
                {profile?.role !== 'national_coordinator' && profile?.role !== 'coordinator' && (
                  <Button
                    size="sm"
                    onClick={() => {
                      setIsSheetOpen(false)
